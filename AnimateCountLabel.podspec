...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/comma/AnimateCountLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'comma' => '506702341@qq.com' }
  s.source           = { :git => 'https://github.com/comma/AnimateCountLabel.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'AnimateCountLabel' => ['AnimateCountLabel/Assets/*.png']
  # }
